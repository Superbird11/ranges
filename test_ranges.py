...
@pytest.mark.parametrize(
    "rng, item, contains, strr, reprr", [
        ...
        (Range(datetime.timedelta(seconds=3600), datetime.timedelta(seconds=7200)), datetime.timedelta(0, 6000), True,
            "[1:00:00, 2:00:00)", "Range[datetime.timedelta(0, 3600), datetime.timedelta(0, 7200))"),
        (Range(datetime.timedelta(days=1, seconds=1804), datetime.timedelta(days=3)), datetime.timedelta(1), False,
